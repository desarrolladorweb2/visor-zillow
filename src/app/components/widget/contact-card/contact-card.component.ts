...
export class ContactCardComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    //if (this.data.layerName === 'cr_terrenos'){
    //  if(this.data.idVisor === '3' || this.data.idVisor === '4'){
    //    this.getInformationCardOferta();
    //  } else {
    //    this.getInformationCardTerreno()
    //  }
    //} else {
    //  this.getInformationCardConstruccion();
    //}
  ...
  async getInformationCardAsset(): Promise<void> {
    ...
    this.contactCardService.getInformacionCardAsset(this.data).subscribe({
      next: async (resp) => {
        ...
        //   } else {
        //     this.imageList = []; // Imagen no existe → no mostrar botón
        //   }
        // } else {
        //   this.imageList = [];
        // }
  ...
  close(): void {
    ...
    //   if (layer.feature) {
    //     const fid =
    //       layer.feature.properties.predio_id ||
    //       layer.feature.properties.cr_unidadesconstruccion_id;
